...
class HMSConfig:
    ...
    def __init__(self):
        ...
        self.HMSPath = "G:/PROJECTS_non-FEMA/MWRD_ReleaseRate_Phase1/H&H/StonyCreek/Stony_V2.0optim/HydrologicModels/" \
                       "ExistingConditions/LucasDitch/LUDT_DesignRuns"
        self.basinin = self.HMSPath + "/LUDT_Design - Copy.basin" #
        self.basinout = self.HMSPath + "/LUDT_Design.basin" #
        self.pdatafile = self.HMSPath + "/LUDT_Design.pdata" #
        self.dssfile = self.HMSPath + "/LUDT_Design.dss" #
        self.stationFileName = self.HMSPath + "/StationList_StonyCreek.txt" #
        self.inputFileName = self.HMSPath + "/LUDT_input.json" #
 ...
 #       self.hmsRunName="100yr12hrHuffARF"
        self.hmsMetFile = self.HMSPath + "/HuffQIII_100yr24hrISWS" #
